...
// Named export used as `import { Timeline } from './ui/timeline'`
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full text-white font-sans md:px-10">
      {/* Outer black band around the teal border */}
      <div className="rounded-[38px] md:rounded-[50px] border-[3px] border-black/80 p-0.5">
        {/* Teal border + card container */}
        <div
          className="rounded-[36px] md:rounded-[48px] overflow-hidden border-2 border-accent bg-neutral-950"
          ref={containerRef}
        >
